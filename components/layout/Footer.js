...
function Footer() {
    ...
    const info = {
        about: [
            {
                id: nanoid(),
                title: "Cianjur, Jawa Barat",
            },
            {
                id: nanoid(),
                title: "+62 812 8187 8727",
            },
            {
                id: nanoid(),
                title: "Senin - Sabtu: 8AM - 8PM"
            },
    ...
    return (
        ...
        >
            ...
            <Stack gridGap="2px" >
                <Heading as="h3" color="#ed6436" fontSize="23px" >Tentang</Heading>
                {
                    info.about.map(e => <Box key={e.id} >{e.title}</Box>)
                }
            </Stack>
            <Stack gridGap="2px" >
                <Heading as="h3" color="#ed6436" fontSize="23px" >Servis Kami</Heading>
                {
                    info.quickLinks.map(e => <Box key={e.id} >{e.title}</Box>)
                }
            </Stack>
            <Stack >
                <Heading as="h3" color="#ed6436" fontSize="23px" >Kirim Email</Heading>
                <Input
